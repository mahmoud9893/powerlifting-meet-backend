...
# Genezio will provide this URL when you deploy
...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        # For production, you'd use a migration tool like Flask-Migrate
        db.create_all()

        # Insert initial MeetState if it doesn't exist
        if MeetState.query.count() == 0:
            db.session.add(MeetState(id=1, current_lift_type='squat', current_attempt_number=1))
            db.session.commit()
    ...
    # Use port 5000 as per previous setup
